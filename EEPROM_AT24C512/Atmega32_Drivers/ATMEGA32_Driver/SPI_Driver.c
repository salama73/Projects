...
/**================================================================
* @Fn				-MCAL_SPI_Init
* @brief		  	-Initializes the SPI  according to the specified parameters in the SPI_Config
* 					 @ ref  SPI_MODE_Define  and  @ ref  SPI_Data_Order_Define  and ....
* @param [in] 		-SPI_Config: configuration information for  SPI 
...
void MCAL_SPI_Init(  SPI_config_t* SPI_Config )
{
	...
	case SPI_Polarity_High_level_idle_state :
		...
		MCAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_SET) ; //set pin idle high 
		break ;
...
/**================================================================
* @Fn				-MCAL_SPI_DeInit
* @brief		  	-Disable clock to SPI and Disable global interrupt
* @retval 			-none
* Note				-none
*/
...
* @brief		  	-send data by SPI data can be 8  and you can used polling_mechanism or interrupt
...
* @brief		  	-send and Receive data by SPI data can be 8  and you can used polling_mechanism or interrupt
* @param [in] 		-polling_mechanism:  Disable or Enable polling_mechanism
